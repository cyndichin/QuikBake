            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="center-heading">
                                ...
                                <span class="center-line"></span>
                                <p>
                                    Nullam vulputate lorem ut leo. Sed volutpat. Etiam non pede. Nullam et mauris. Praesent<br>
                                    sed elit. Nulla posuere. Etiam sit amet turpis. Nullam mattis libero non
                                </p>
                            </div>
                        </div>
                    </div><!--center heading end-->
                ...
                <div class="col-md-12">
                    <ul class=" portfolio-filters text-center">
                        ...
                        <li class="filter" data-filter="page1">Media</li>
                        <li class="filter" data-filter="page2">Photography</li>
                        <li class="filter" data-filter="page3">HTML5</li>
                        <li class="filter" data-filter="page4">Wordpress</li>
                    </ul>
                </div>
            </div>

            <div id="grid" class="full-width-3-work">
                <div class="mix col-sm-4 page1 page4 no-padding">
                ...
                <div class="mix col-sm-4 page2 page3  no-padding">
                    <div class="item-img-wrap ">
                    ...
                    <div class="work-desc">
                        <h3><a href="portfolio-single.html">Mockup Design</a></h3>
                        <span>Photoshop</span>
                    </div><!--work desc-->
                </div>
                <div class="mix col-sm-4  page3 page2  no-padding ">
                    <div class="item-img-wrap ">
                    ...
                    <div class="work-desc">
                        <h3><a href="portfolio-single.html"> Real estate</a></h3>
                        <span>Php</span>
                    </div><!--work desc-->
                </div>
                <div class="mix col-sm-4  page4  no-padding">
                    <div class="item-img-wrap ">
                    ...
                    <div class="work-desc">
                        <h3><a href="portfolio-single.html">E Commerce</a></h3>
                        <span>magento</span>
                    </div><!--work desc-->
                </div>
                <div class="mix col-sm-4 page1  no-padding ">
                    <div class="item-img-wrap ">
                    ...
                    <div class="work-desc">
                        <h3><a href="portfolio-single.html">Website Design</a></h3>
                        <span>Html5 / Css3</span>
                    </div><!--work desc-->
                </div>
                <div class="mix col-sm-4  page2  no-padding">
                    <div class="item-img-wrap ">
                ...
                <div class="mix col-sm-4  page3  no-padding">
                    <div class="item-img-wrap ">
                        <img src="img/img-6.jpg" class="img-responsive" alt="workimg">
                        <div class="item-img-overlay">
                            <a href="img/img-6.jpg" class="show-image">
                    ...
                    <div class="work-desc">
                        <h3><a href="portfolio-single.html">Website Develop </a></h3>
                        <span>Wordpress</span>
                    </div><!--work desc-->
                </div>
                <div class="mix col-sm-4 page4   no-padding">
                ...
                <div class="col-sm-6 col-sm-offset-6 no-padding gray">
                    <div class="no-padding-inner gray">
                        ...
                        <div class="services-box margin30 wow animated fadeInRight">
                            ...
                            <div class="services-box-info">
                                <h4>60+ valid HTML5 Pages and much more...</h4>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing metus. elit. Quisque rutrum pellentesque imperdiet.
                                </p>
                            </div>
